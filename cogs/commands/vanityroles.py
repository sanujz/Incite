...
class Vanityroles(commands.Cog):
            ...
            if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
                if role.permissions.administrator or role.permissions.ban_members or role.permissions.kick_members:
                    embed1 = discord.Embed(
                        description=
                        "<:Incite_Failure:1251971011855913011> | Please Select Role That Dont Have Any Type Of Dangerous Permissions.",
                        color=0x2f3136)
                    ...
                    embed.add_field(
                        name="<:Incite_Arrow:1252133991281070110> Vanity",
                        value=f"{vanity}",
                        inline=False)
                    embed.add_field(
                        name="<:Incite_Arrow:1252133991281070110> Role",
                        value=f"{role.mention}",
                        inline=False)
                    embed.add_field(
                        name="<:Incite_Arrow:1252133991281070110> Channel",
        ...
        with open("vanityroles.json", "r") as f:
            ...
            if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
                if str(ctx.guild.id) not in jnl:
                    embed1 = discord.Embed(
                        description=
                        "<:Incite_Failure:1251971011855913011> | This server don't have any vanity roles setupped yet .",
                        color=0x2f3136)
    ...
    async def config(self, ctx):
        ...
        if str(ctx.guild.id) not in jnl:
            ...
            embed.add_field(name="<:Incite_Arrow:1252133991281070110> Vanity",
                            value=f"{vanity}",
                            inline=False)
            embed.add_field(name="<:Incite_Arrow:1252133991281070110> Role",
                            value=f"{randirole.mention}",
                            inline=False)
            embed.add_field(name="<:Incite_Arrow:1252133991281070110> Channel",
