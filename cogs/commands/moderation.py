...
class Moderation(commands.Cog):
    ...
    async def unlockall(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:Incite_Success:1251971018033987654> | Unlocking all channels in few seconds .")
    ...
    async def lockall(self, ctx, server: discord.Guild = None, *, reason=None):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:Incite_Success:1251971018033987654> | Locking all channels in few seconds .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        await ctx.reply(embed=hacker)
        if server is None: server = ctx.guild
    ...
    async def give(
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role not in member.roles:
                ...
                description=
                f"<:Incite_Success:1251971018033987654> | Changed roles for {member.name}, +{role.name}",
                color=0x2f3136)
    ...
    async def _hideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:Incite_Success:1251971018033987654> | Hiding all channels in few seconds .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _unhideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:Incite_Success:1251971018033987654> | Unhiding all channels in few seconds .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url =f"{ctx.author.avatar}")
        await ctx.reply(embed=hacker)
    ...
    async def _hide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:Incite_Success:1251971018033987654> | Succefully Hidden {channel.mention} .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _unhide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:Incite_Success:1251971018033987654> | Succefully Unhidden {channel.mention} .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
...
Reason: `{entry.reason}`\n\n''')
    ...
    async def _prefix(self, ctx: commands.Context, prefix):
      ...
      if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:         
          ...
          await ctx.reply(embed=discord.Embed(
            description=
            f"<:Incite_Success:1251971018033987654> | Successfully Changed Prefix For **{ctx.guild.name}**\nNew Prefix for **{ctx.guild.name}** is : `{prefix}`\nUse `{prefix}help` For More info .",
            color=0x2f3136))
      else:
          hacker5 = discord.Embed(
                description=
    ...
    async def purge(self, ctx, amount: int = 10):
        ...
        return await ctx.send(
            f"**<:Incite_Success:1251971018033987654> Deleted {len(deleted)-1} message(s)**"
        )
    ...
    async def startswith(self, ctx, key, amount: int = 10):
        ...
        return await ctx.send(
            f"**<:Incite_Success:1251971018033987654> Deleted {len(deleted)}/{amount} message(s) which started with the given keyword**"
        )
    ...
    async def endswith(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:Incite_Success:1251971018033987654> Deleted {len(deleted)}/{amount} message(s) which ended with the given keyword**"
        )
    ...
    async def contains(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:Incite_Success:1251971018033987654> Deleted {len(deleted)}/{amount} message(s) which contained the given keyword**"
        )
    ...
    async def user(self, ctx, user: discord.Member, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:Incite_Success:1251971018033987654> Deleted {len(deleted)}/{amount} message(s) which were sent by the mentioned user**"
        )
    ...
    async def invites(self, ctx, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:Incite_Success:1251971018033987654> Deleted {len(deleted)}/{amount} message(s) which contained invites**"
        )
    ...
    async def _mute(self, ctx, member: discord.Member, duration):
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            ...
            if tame == -1:
                ...
                color=0x2f3136,
                description=
                f"<:Incite_Error:1251971046475567227>  | You didnt didnt gave time with correct unit\nExamples:\n{ctx.prefix}mute{ctx.author} 10m\n{ctx.prefix}mute {ctx.author} 5hr",
                ...
                color=0x2f3136,
                description=
                f"<:Incite_Error:1251971046475567227>  | Time must be an integer!",
                timestamp=ctx.message.created_at)
                ...
                if till.lower() == "d":
                    ...
                    color=0x2f3136,
                    description=
                    "<:Incite_Success:1251971018033987654> | Successfully Muted {0.mention} For {1} Day(s)"
                    .format(member, ok))
                elif till.lower() == "m":
                    t = datetime.timedelta(seconds=tame)
                    hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:Incite_Success:1251971018033987654> | Successfully Muted {0.mention} For {1} Minute(s)"
                    .format(member, ok))
                    ...
                    color=0x2f3136,
                    description=
                    "<:Incite_Success:1251971018033987654> | Successfully Muted {0.mention} For {1} Second(s)"
                    .format(member, ok))
                    ...
                    color=0x2f3136,
                    description=
                    "<:Incite_Success:1251971018033987654> | Successfully Muted {0.mention} For {1} Hour(s)"
                    .format(member, ok))
            try:
                if member.guild_permissions.administrator:
                    ...
                    color=0x2f3136,
                    description=
                    "<:Incite_Error:1251971046475567227>  | I can\'t mute administrators")
...
<:Incite_Failure:1251971011855913011> You need certain Incite Permissions to use this command!
       <:Incite_Arrow:1252133991281070110> You need one of those permissions:
       `Timeout Command`
       """)
            error.set_author(
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            if member.is_timed_out():
                try:
                    ...
                    color=0x2f3136,
                    description=
                    f"<:Incite_Success:1251971018033987654> | Successfully Unmuted {member.name}")
                    await ctx.reply(embed=hacker5)
                except Exception as e:
                    hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:Incite_Error:1251971046475567227>  | Unable to Remove Timeout:\n```py\n{}```"
                    .format(e))
                    await ctx.send(embed=hacker)
            else:
                hacker1 = discord.Embed(
                color=0x2f3136,
                description="<:Incite_Error:1251971046475567227>  | {} Is Not Muted".
...
<:Incite_Failure:1251971011855913011> You need certain Incite Permissions to use this command!
    ...
    @commands.hybrid_command(
        name="kick",
        aliases=['k'],
        help="Somebody is breaking rules simply kick them from the server as punishment",
        usage="kick <member>")
    @blacklist_check()
    @ignore_check()
    ...
    async def _kick(self, ctx: commands.Context, member: discord.Member, *, reason=None):
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            ...
            elif ctx.author.top_role.position > member.top_role.position or ctx.author == ctx.guild.owner:
                try:
                    await member.kick(reason=reason)
                    hacker = discord.Embed(
                        color=0x2f3136,
                        description=f"<:Incite_Success:1251971018033987654> | {member.display_name} has been kicked from this guild, for: {reason}")
                    hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
                    
                    await ctx.send(embed=hacker)
                    hacker1 = discord.Embed(
                        color=0x2f3136,
                        description=f":exclamation: | You have been kicked from {ctx.guild.name} for: {reason} By [{ctx.author}](https://discord.com/users/{ctx.author.id})")
    ...
    <:Incite_Failure:1251971011855913011> You need certain Incite Permissions to use this command!
       ...
       """)
            error.set_author(
                name="You can't use this command!",
    ...
    async def _warn(self,ctx: commands.Context,member: discord.Member,*,reason=None):
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            ...
            color=0x2f3136,
            description=
            f"<:Incite_Success:1251971018033987654> | {member.display_name} has been warned for: {reason}")
            hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
...
<:Incite_Failure:1251971011855913011> You need certain Incite Permissions to use this command!
    ...
    @commands.hybrid_command(
        name='ban',
        aliases=['b'],
        help="Somebody is breaking rules again and again | ban them from the server as punishment",
        usage="ban [member]")
    @blacklist_check()
    @ignore_check()
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            if member == self.bot:
                ...
                try:
                    ...
                    hacker = discord.Embed(
                        color=0x2f3136,
                        description=f"<:Incite_Success:1251971018033987654> | {member.display_name} has been successfully banned")
                    hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
                
                    await ctx.send(embed=hacker)
                    hacker1 = discord.Embed(
                        color=0x2f3136,
                        description=f":exclamation: | You have been banned from {ctx.message.guild.name} for reason: `{reason}` By [{ctx.author}](https://discord.com/users/{ctx.author.id})")
                    await member.send(embed=hacker1)
                except:
                    pass
            else:
    ...
    @commands.hybrid_command(
        name="unban",
        help="If someone realizes their mistake you should unban them",
        usage="unban [user]")
    @blacklist_check()
    @commands.has_permissions(ban_members=True)
    async def _unban(self, ctx: commands.Context, id: int):
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            ...
            color=0x2f3136,
            description=
            f"<:Incite_Success:1251971018033987654> | {user.name} has been successfully unbanned")
            hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
...
<:Incite_Failure:1251971011855913011> You need certain Incite Permissions to use this command!
    ...
    async def clone(self, ctx: commands.Context, channel: discord.TextChannel):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:Incite_Success:1251971018033987654> | {channel.name} has been successfully cloned")
    ...
    async def changenickname(self, ctx: commands.Context,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:Incite_Success:1251971018033987654> | Successfully changed nickname of {member.name}")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _reactions(self, ctx, search=1000):
        ...
        await ctx.send(embed=discord.Embed(
            description=
            f"<:Incite_Success:1251971018033987654> | Successfully Removed {total_reactions}.",
            color=0x2f3136))
    ...
    async def _nuke(self,
        ...
        async def button1_callback(interaction: discord.Interaction):
            if interaction.user == ctx.author:
                await interaction.response.edit_message(
                    content="Ok I Won't Nuke Channel",
                    embed=None,
                    view=None)
            else:
                await interaction.response.send_message(
    ...
    async def _lock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="Incite | Lockdown",
                description=
                "<:Incite_Success:1251971018033987654> | Successfully locked **%s**"
                % (channel.mention),
                color=0x2f3136))
        except:
            await ctx.send(
                embed=discord.Embed(title="Incite | Lockdown",
    ...
    async def _unlock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="Incite | Unlockdown",
                description=
                "<:Incite_Success:1251971018033987654> | Successfully unlocked **%s**"
                % (channel.mention),
                color=0x2f3136))
        except:
            await ctx.send(
                embed=discord.Embed(title="Incite | Unlockdown",
...
**Description:** {pack.description}
    ...
    async def temp(self, ctx, role: discord.Role, time, *,
        ...
        if role == ctx.author.top_role:
            embed = discord.Embed(
                description=
                f"<:Incite_Failure:1251971011855913011> | {role} has the same position as your top role!",
                color=0x2f3136)
            ...
            if role.position >= ctx.guild.me.top_role.position:
                embed1 = discord.Embed(
                    description=
                    f"<:Incite_Failure:1251971011855913011> | {role} is higher than my role, move my role above {role}.",
                    color=0x2f3136)
        ...
        hacker = discord.Embed(
            description=
            f"<:Incite_Success:1251971018033987654> | Successfully added {role.mention} to {user.mention} .",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def remove(self, ctx, user: discord.Member, role: discord.Role):
        ...
        hacker = discord.Embed(
            description=
            f"<:Incite_Success:1251971018033987654> | Successfully removed {role.mention} from {user.mention} .",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def delete(self, ctx, role: discord.Role):
        ...
        if role is None:
            embed2 = discord.Embed(
                description=
                f"<:Incite_Failure:1251971011855913011> | No role named {role} found in this server .",
                color=0x2f3136)
            return await ctx.send(embed=embed2)
        await role.delete()
        hacker = discord.Embed(
            description=
            f"<:Incite_Success:1251971018033987654> | Successfully deleted {role}",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def create(self, ctx, *, name):
        ...
        if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
            hacker = discord.Embed(
                description=
                f"<:Incite_Success:1251971018033987654> | Successfully created role with the name {name}",
                color=0x2f3136)
    ...
    async def rename(self, ctx, role: discord.Role, *, newname):
        ...
        if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
            ...
            await ctx.send(
                f"<:Incite_Success:1251971018033987654> | Role {role.name} has been renamed to {newname}"
            )
        elif role is None:
            embed2 = discord.Embed(
                description=
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(wled) == 30:
                hacker = discord.Embed(
                    title="Incite",
                    description=
                    "<:Incite_Arrow:1252133991281070110> You are trying to add more users than what it's allowed in [Trusted admins]!",           color=0x2f3136)
                hacker.set_author(
                ...
                if str(user.id) in wled:
                    hacker1 = discord.Embed(
                        color=0x2f3136)
                    hacker1.add_field(
                    name="<:Incite_Success:1251971018033987654> Successful Operations",
                    value="No successful operation!",
                    inline=False)
                    hacker1.add_field(
                    name="<:Incite_Failure:1251971011855913011> Unsuccessful Operations",
                    value=f"""<:Incite_Arrow:1252133991281070110> `{user}` <:Incite_Failure:1251971011855913011>
                                                               <:Incite_Arrow:1252133991281070110> *Already exists!*""",
                   inline=False)
                    hacker1.set_author(
                ...
                if ctx.author.avatar else ctx.author.default_avatar.url)
                    ...
                    hacker4.add_field(
                    name="<:Incite_Success:1251971018033987654> Successful Operations",
                    value=f"<:Incite_Arrow:1252133991281070110> `{user}`",
                    inline=False)
                    hacker4.add_field(
                    name="<:Incite_Failure:1251971011855913011> Unsuccessful Operations",
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if str(user.id) in wled:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    title="Incite",
                    description=f"<:Incite_Success:1251971018033987654> | Successfully Removed {user.mention} From admin list For {ctx.guild.name}"
                )
                await ctx.reply(embed=hacker, mention_author=False)
            else:
                hacker2 = discord.Embed(
                    ...
                    title="Incite",
                    description=
                    "<:Incite_Failure:1251971011855913011> | That user is not in my admin list ."
                )
    ...
    async def admin_show(self, ctx):
        ...
        if len(wled) == 0:
            hacker = discord.Embed(
                ...
                title="Incite",
                description=
                f"<:Incite_Failure:1251971011855913011> | There aren\'t any admin users for this server"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            entries = [
    ...
    async def wl_reset(self, ctx: Context):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                ...
                title="Incite",
                description=
                f"<:Incite_Success:1251971018033987654> | Successfully Cleared admin Database For **{ctx.guild.name}**"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            hacker5 = discord.Embed(
    ...
    async def whitelist_role(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker4 = discord.Embed(
                ...
                title="Incite",
                description=
                f"<:Incite_Success:1251971018033987654> | {role.mention} Has Been Added To admin Role For {ctx.guild.name}"
            )
            await ctx.reply(embed=hacker4, mention_author=False)
    ...
    async def addsticker(self, ctx: commands.Context, *, name=None):
          ...
          try:
              ...
              await ctx.reply(f"<:Incite_Success:1251971018033987654> | Sucessfully created sticker with name `{name}`", stickers=[s])
          except:
              return await ctx.reply("Failed to create the sticker")
        
    @commands.hybrid_command(aliases=["deletesticker", "removesticker"], help="Delete the sticker from the server")
    @commands.has_permissions(manage_emojis=True)
