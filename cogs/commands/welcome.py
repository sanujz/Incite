    ...
    async def _autorole_humans_reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if rl == []:
                embed = discord.Embed(
                    description=
                    "<:Incite_Failure:1251971011855913011> | This server don't have any autoroles setupped .",
                    color=0x2f3136)
                ...
                if rl != []:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:Incite_Success:1251971018033987654> | Succesfully cleared all human autoroles for {ctx.guild.name} .",
                        color=0x2f3136)
    ...
    async def _autorole_bots_reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if rl == []:
                embed = discord.Embed(
                    description=
                    f"<:Incite_Failure:1251971011855913011> | This server don't have any autoroles setupped .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if rl != []:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:Incite_Success:1251971018033987654> | Succesfully cleared all bot autoroles for this server .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(brl) == 0 and len(hrl) == 0:
                ...
                if hrl != []:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:Incite_Success:1251971018033987654> | Succesfully cleared all autoroles for this server .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
    ...
    async def _autorole_humans_add(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 5:
                embed = discord.Embed(
                    description=
                    f"<:Incite_Failure:1251971011855913011> | You have reached maximum channel limit for autorole humans which is five .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if str(role.id) in rl:
                    embed1 = discord.Embed(
                        description=
                        "<:Incite_Failure:1251971011855913011> | {} is already in human autoroles ."
                        .format(role.mention),
                        color=0x2f3136)
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:Incite_Success:1251971018033987654> | {role.mention} has been added to human autoroles .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
    ...
    async def _autorole_humans_remove(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 0:
                embed = discord.Embed(
                    description=
                    f"<:Incite_Failure:1251971011855913011> | This server dont have any autrole humans setupped yet .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if str(role.id) not in rl:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:Incite_Success:1251971018033987654> | {role.mention} has been removed from human autoroles .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
    ...
    async def _autorole_bots_add(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 5:
                embed = discord.Embed(
                    description=
                    f"<:Incite_Failure:1251971011855913011> | You have reached maximum role limit for autorole bots which is five.",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if str(role.id) in rl:
                    embed1 = discord.Embed(
                        description=
                        "<:Incite_Failure:1251971011855913011> | {} is already in bot autoroles."
                        .format(role.mention),
                        color=0x2f3136)
                    await ctx.send(embed=embed1)
                else:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:Incite_Success:1251971018033987654> | {role.mention} has been added to bot autoroles .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 0:
                ...
                if str(role.id) not in rl:
                    embed1 = discord.Embed(
                        description=
                        "<:Incite_Failure:1251971011855913011> | {} is not in bot autoroles."
                        .format(role.mention),
                        color=0x2f3136)
                    await ctx.send(embed=embed1)
                else:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:Incite_Success:1251971018033987654> | {role.mention} has been removed from bot autoroles.",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(thumbnail_link):
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:Incite_Success:1251971018033987654> | Successfully updated the welcome thumbnail url .")
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(image_link):
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:Incite_Success:1251971018033987654> | Successfully updated the welcome image url .")
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
            else:
    ...
    async def _greet_autodel(self, ctx, *, autodelete_second):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<:Incite_Success:1251971018033987654> | Successfully updated the welcome autodelete second to {autodelete_second} .\nFrom now welcome message will be deleted after {autodelete_second} .",
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            try:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:Incite_Success:1251971018033987654> | Successfully updated the welcome message .")
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
        else:
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["embed"] == True:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:Incite_Success:1251971018033987654> | Okay, Now your embed is removed and welcome message will be a plain message .")
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                hacker1 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:Incite_Success:1251971018033987654> | Okay, Now your embed is enabled and welcome message will be a embed message.")
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["ping"] == True:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:Incite_Success:1251971018033987654> | Okay, Now your embed ping is disabled and users won't get pinged upon welcome .")
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                hacker1 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:Incite_Success:1251971018033987654> | Okay, Now your embed ping is enabled and I will ping new users outside the embed .")
                hacker1.set_author(name=f"{ctx.author.name}",
                                   icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker1)
        else:
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(chh) == 1:
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:Incite_Error:1251971046475567227>  | You have reached maximum channel limit for channel which is one .")
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
            else:
                if str(channel.id) in chh:
                    hacker1 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:Incite_Error:1251971046475567227>  | This channel is already in the welcome channels list .")
                    hacker1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker1)
                else:
                    ...
                    hacker4 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:Incite_Success:1251971018033987654> | Successfully added {channel.mention} to welcome channel list .")
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(chh) == 0:
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:Incite_Error:1251971046475567227>  | This server dont have any welcome channel setupped yet .")
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
            else:
                if str(channel.id) not in chh:
                    hacker1 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:Incite_Error:1251971046475567227>  | This channel is not in the welcome channels list .")
                    hacker1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker1)
                else:
                    ...
                    hacker3 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:Incite_Success:1251971018033987654> | Successfully removed {channel.mention} from welcome channel list .")
    ...
    async def welctestt(self, ctx):
        ...
        if chan == []:
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<:Incite_Error:1251971046475567227>  | Oops, Kindly setup your welcome channel first .")
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
        else:
    ...
    async def _reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["channel"] == []:
                embed = discord.Embed(
                    description=
                    "<:Incite_Failure:1251971011855913011> | This server don't have any greet channel setuped yet .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                ...
                hacker = discord.Embed(
                    description=
                    "<:Incite_Success:1251971018033987654> | Succesfully cleared all greet config for this server .",
                    color=0x2f3136)
                await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
