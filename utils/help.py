...
class View(discord.ui.View):
    ...
    def add_buttons(self):
        ...
        self.endB = Buttons(label="≫",
                            ...
                            ctx=self.ctx)
        self.quitB = randi(emoji="<:Incite_Button:1252174112017616896>",
                             style=discord.ButtonStyle.grey,
                             command=self.quit,
                             ctx=self.ctx)
    ...
    def gen_embeds(self):
        ...
        options.append(
            discord.SelectOption(label="Home",
                                 emoji='<:Incite_Home:1251971008156401695>', description="Show you home template"))
        ...
        for cog in self.get_cogs():
            if "help_custom" in dir(cog):
                ...
                embed.set_footer(
                    ...
                    icon_url=
                    "https://images-ext-1.discordapp.net/external/jVplHhnx7o-NSZruuCl2zm8KATCc5DNJL67L29H-_Zw/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/1251900087932817471/37e598149a590bec31c732ee263960fd.png?format=webp&quality=lossless&width=450&height=450"
                )
